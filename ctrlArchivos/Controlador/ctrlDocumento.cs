...
namespace ctrlArchivos.Controlador
{
    public class ctrlDocumento
    {
        ...
        public void enlistarDatos(Table datos)
        {
            ...
            header.Cells.Add(celda);
            celda = new TableCell();
            celda.Text = "Prioridad";
            header.Cells.Add(celda);
            celda = new TableCell();
            celda.Text = "Remitente";
            header.Cells.Add(celda);
            celda = new TableCell();
            celda.Text = "No. Documento";
            header.Cells.Add(celda);
            celda = new TableCell();
            celda.Text = "Fecha";
            header.Cells.Add(celda);
            celda = new TableCell();
            celda.Text = "Destinatario";
            header.Cells.Add(celda);
            celda = new TableCell();
            celda.Text = "Fecha Recepción";
            header.Cells.Add(celda);
            celda = new TableCell();
            celda.Text = "Hora Recepción";
            header.Cells.Add(celda);
            celda = new TableCell();
            celda.Text = "Asunto";
            header.Cells.Add(celda);
            ...
            header.Cells.Add(celda);
            celda = new TableCell();
            celda.Text = "Estatus Delegado";
            header.Cells.Add(celda);
            celda = new TableCell();
            celda.Text = "Fecha Delegación";
            header.Cells.Add(celda);
